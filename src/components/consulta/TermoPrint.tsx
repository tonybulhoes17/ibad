  ...
  ({ record: r, profile }, ref) => {
    return (
      ...
      >
        ...
        {/* CABEÇALHO */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '2px solid #1A56A0', paddingBottom: 8, marginBottom: 14, flexShrink: 0 }}>
        ...
        {/* CONTEÚDO PRINCIPAL — cresce para ocupar o espaço */}
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          {/* ASSINATURA MÉDICO — empurrada para o rodapé */}
