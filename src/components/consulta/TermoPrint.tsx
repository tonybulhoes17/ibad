  ...
  ({ record: r, profile }, ref) => {
    return (
      <div ref={ref} className="a4-preview print-only" style={{ fontFamily: 'Arial, sans-serif', width: '105%' }}>
        ...
        {/* CABEÇALHO */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '2px solid #1A56A0', paddingBottom: 8, marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div>
              <div style={{ fontSize: 18, fontWeight: 'bold', color: '#1A56A0', letterSpacing: 1 }}>TERMO DE CIÊNCIA</div>
            </div>
          </div>
        ...
        {/* TEXTO */}
        <div style={{ fontSize: 9.5, lineHeight: 1.7, color: '#1E293B', marginBottom: 12, textAlign: 'justify' }}>
          ...
          <div style={{ background: '#F1F5F9', padding: '4px 8px', marginBottom: 8, fontWeight: 'bold', fontSize: 9 }}>
        ...
        {/* TEXTO MÉDICO */}
        <div style={{ fontSize: 9.5, lineHeight: 1.7, color: '#1E293B', marginBottom: 16, textAlign: 'justify' }}>
