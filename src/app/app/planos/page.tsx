...
export default function PlanosPage() {
  const { planos, loading, create, remove } = usePlanos()
  ...
  return (
    <div className="p-4 lg:p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h1 className="text-xl font-bold text-slate-900">Planos de Saúde</h1>
          <p className="text-sm text-slate-500">Convênios aceitos</p>
        </div>
