...
import { Plus, Loader2, Trash2, CheckCircle2, Clock, Building2, Calendar, Moon } from 'lucide-react'
    ...
    <div className="p-4 lg:p-6 max-w-4xl mx-auto">
      ...
      {showForm && (
        <div className="card p-5 mb-5 animate-fade-in">
          <h2 className="text-sm font-semibold text-slate-700 mb-4">Novo Plantão</h2>
      ...
      {loading ? (
        ...
        <div className="card overflow-hidden">
          <div className="divide-y divide-slate-50">
            {shifts.map(s => (
              <div key={s.id} className="flex items-center gap-4 px-5 py-4 hover:bg-slate-50 group">
