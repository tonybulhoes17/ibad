...
export default function InstituicoesPage() {
  const { instituicoes, loading, create, update, remove } = useInstituicoes()
  ...
  function startEdit(inst: { id: string; name: string; city: string | null; notes: string | null; logo_url: string | null }) {
    ...
    <div className="p-4 lg:p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm text-slate-500">Hospitais e clínicas onde você trabalha</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input type="text" className="form-input" placeholder="São Paulo"
